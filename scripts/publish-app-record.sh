...
services:
  registry:
    rpcEndpoint: '${CERC_REGISTRY_REST_ENDPOINT:-http://laconicd.spidey.services:26657}'
    gqlEndpoint: '${CERC_REGISTRY_GQL_ENDPOINT:-http://laconicd.spidey.services:9473/api}'
